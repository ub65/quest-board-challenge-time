...
>(({ className, children, ...props }, ref) => {
  // Use localization for close button placement (RTL for Hebrew)
  const { language } = useLocalization ? useLocalization() : { language: "en" }

  // If Hebrew, move close button to the left; otherwise, right
  const closeBtnPos = language === "he"
    ? "left-4 top-4 right-auto"
    : "right-4 top-4 left-auto"
