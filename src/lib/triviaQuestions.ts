...
const EASY_TRIVIA = [
  {
  prompt: "מה שותים בבוקר כדי להתעורר?",
  answers: ["מיץ", "מים", "קפה", "תה"],
  correct: 2
},
{
  prompt: "מה שמים על הראש להגנה מהשמש?",
  answers: ["מעיל", "כובע", "מגפיים", "כפפות"],
  correct: 1
},
{
  prompt: "איזו חיה אומרת 'מו'?",
  answers: ["כבשה", "תרנגולת", "חתול", "פרה"],
  correct: 3
},
{
  prompt: "איפה שמים ספרים?",
  answers: ["תיק", "שולחן", "מדף", "מיטה"],
  correct: 2
},
{
  prompt: "איזה כלי רכב נוסע על מסילה?",
  answers: ["מטוס", "אוטובוס", "רכבת", "אופניים"],
  correct: 2
},
{
  prompt: "מה עושים עם מברשת שיניים?",
  answers: ["מסתרקים", "מצחצחים שיניים", "מנקים שולחן", "כותבים"],
  correct: 1
},
{
  prompt: "מה יש לשמש בשמים?",
  answers: ["אור", "גשם", "שלג", "רוח"],
  correct: 0
},
{
  prompt: "מהו המאכל שעושים מגלידה?",
  answers: ["פיצה", "עוגה", "שוקולד", "קינוח"],
  correct: 3
},
{
  prompt: "מה שמים על הרגליים כשקר?",
  answers: ["כובע", "כפפות", "גרביים", "חולצה"],
  correct: 2
},
{
  prompt: "מה שומעים באוזניים?",
  answers: ["אור", "ריח", "קול", "טעם"],
  correct: 2
},
...
const MEDIUM_TRIVIA = [
  {
  prompt: "כמה מדינות גובלות עם ישראל?",
  answers: ["3", "4", "5", "6"],
  correct: 2
},
{
  prompt: "מה השם של ההר הכי גבוה בישראל?",
  answers: ["הר תבור", "הר הכרמל", "הר החרמון", "הר מירון"],
  correct: 2
},
{
  prompt: "מי כתב את 'התקווה'?",
  answers: ["חיים נחמן ביאליק", "נפתלי הרץ אימבר", "אורי צבי גרינברג", "שאול טשרניחובסקי"],
  correct: 1
},
{
  prompt: "איזו עיר מכונה 'עיר הבירה הכלכלית' של ישראל?",
  answers: ["חיפה", "ירושלים", "תל אביב", "באר שבע"],
  correct: 2
},
{
  prompt: "מה שם העצמאות של ארצות הברית?",
  answers: ["1 בינואר", "14 ביולי", "4 ביולי", "15 באוגוסט"],
  correct: 2
},
{
  prompt: "מהו התחום של אלברט איינשטיין?",
  answers: ["כימיה", "ביולוגיה", "פיזיקה", "היסטוריה"],
  correct: 2
},
{
  prompt: "מהי עיר הולדתו של הרצל?",
  answers: ["וינה", "בודפשט", "ברלין", "תל אביב"],
  correct: 1
},
{
  prompt: "כמה קלידים יש בפסנתר רגיל?",
  answers: ["76", "80", "88", "90"],
  correct: 2
},
{
  prompt: "איזה ים נמצא מדרום לישראל?",
  answers: ["הים האדום", "הים השחור", "הים הכספי", "הים הבלטי"],
  correct: 0
},
{
  prompt: "מהו שמה של העיר העתיקה ליד ים המלח?",
  answers: ["עין גדי", "יריחו", "מצדה", "ערד"],
  correct: 2
},
...
const HARD_TRIVIA = [
  {
  prompt: "מהו שמו של חוזה השלום הראשון שישראל חתמה עליו?",
  answers: ["הסכם קמפ דייוויד", "הסכם אוסלו", "הסכם ואדי ערבה", "הסכם מדריד"],
  correct: 0
},
{
  prompt: "מי ייסד את אגודת 'בני ברית' בישראל?",
  answers: ["ברוך שפינוזה", "יצחק גרינבוים", "מקס נורדאו", "לאון פינסקר"],
  correct: 2
},
{
  prompt: "מהו הספר הראשון שנדפס בדפוס עברי?",
  answers: ["משנה תורה", "סידור תפילה", "חומש", "תנ\"ך"],
  correct: 3
},
{
  prompt: "מהו שמה של תכנית החלל הישראלית?",
  answers: ["תבל", "אופק", "שחר", "ניצן"],
  correct: 1
},
{
  prompt: "איזה ראש ממשלה כיהן לתקופה הארוכה ביותר בישראל?",
  answers: ["דוד בן גוריון", "בנימין נתניהו", "יצחק שמיר", "גולדה מאיר"],
  correct: 1
},
{
  prompt: "כמה פעמים נבחר שמעון פרס לראש ממשלה?",
  answers: ["פעם אחת", "פעמיים", "שלוש פעמים", "מעולם לא"],
  correct: 1
},
{
  prompt: "מי היה הרב הראשי הראשון של מדינת ישראל?",
  answers: ["הרב קוק", "הרב עוזיאל", "הרב הרצוג", "הרב עובדיה יוסף"],
  correct: 2
},
{
  prompt: "מהו שם הספר שכתב הרמב\"ם על הרפואה?",
  answers: ["מורה נבוכים", "היגיון הבריאות", "הנהגת הבריאות", "שמונה פרקים"],
  correct: 2
},
{
  prompt: "כמה פעמים זכתה ישראל באירוויזיון עד 2024?",
  answers: ["2", "3", "4", "5"],
  correct: 2
},
{
  prompt: "איזו מדינה ערבית הייתה הראשונה שחתמה על שלום עם ישראל?",
  answers: ["ירדן", "לבנון", "מצרים", "מרוקו"],
  correct: 2
},
